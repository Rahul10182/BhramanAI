...
export const flightNode = async (state: typeof PlannerStateAnnotation.State) => {
    ...
    try {
        ...
        response = await executeToolLoop(flightLLM, systemMessage, safeMessages, response, flightTools, "Flight");
